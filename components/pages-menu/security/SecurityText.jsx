  ...
  return (
    <>
      <div className="text-box" style={{padding: "0 5%"}}>
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>1. Preamble</h3>
          <p>
            This Security & Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and informs You about Your security & privacy rights and how the law protects You. We use Your personal data to provide and improve the Service. By using the website, You agree to the collection and use of Your information in accordance with this Security & Privacy Policy.
          </p>
          <p>
            This Security & Privacy Policy was last updated on: February 20, 2024.
          </p>
        </p>
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>2. Interpretation and Definitions </h3>
          <strong> Interpretation </strong>
          <p>
            The words in which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or plural form.
          </p>
          <strong> Definitions </strong>
          <p>
            For the purposes of this Security & Privacy Policy:
          </p>
          <div>
            <ul className="list-style-six">
              <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
              <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority. </li>
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Future Fit International (FFI), 168 Charlotte St #404, Ottawa, ON K1N 8K6, Canada.</li>
              ...
              <li><strong>Website</strong> refers to Future Fit International (FFI), accessible from <a href="/" style={{ color: GlobalConfig.Fgr1Clr }}>https://futurefitinternational.com</a></li>
        ...
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>3. Collecting and Using Your Personal Data</h3>
          <p style={{ fontSize: '120%' }}> <strong> Types of Data Collected </strong> </p>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Use of Your Personal Data </strong> </p>
          <p>
          ...
          <div>
            <ul className="list-style-six">
              ...
              <li><strong>With Affiliates: We may </strong>
                share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.
              </li>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Retention of Your Personal Data </strong> </p>
          <p>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Transfer of Your Personal Data </strong> </p>
          <p>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Delete Your Personal Data </strong> </p>
          <p>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Disclosure of Your Personal Data </strong> </p>
          ...
          <p style={{ fontSize: '120%' }}> <strong> Security of Your Personal Data </strong> </p>
          <p>
        ...
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>4. Children's Policy</h3>
          <p>
        ...
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>5. Links to Other Websites</h3>
          <p>
        ...
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>6. Changes to this Privacy Policy</h3>
          <p>
        ...
        <p>
          <h3 style={{ color: GlobalConfig.Fgr1Clr }}>7. Contact Us</h3>
          <p>
