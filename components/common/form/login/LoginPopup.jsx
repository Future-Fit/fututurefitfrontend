...
const LoginPopup = ({ closeMe, myToast, myError, myAdminError, closeAdminMe, myAdminToast }) => {
  ...
  return (
    <>
      ...
      <div className="modal fade" id="forgetPassPopupModal">
        <div className="modal-dialog modal-lg modal-dialog-centered login-modal modal-dialog-scrollable">
          <div className="modal-content">
            <button
              type="button"
      ...
      <div className="modal fade" id="registerModalAdmin">
        <div className="modal-dialog modal-lg modal-dialog-centered login-modal modal-dialog-scrollable">
          <div className="modal-content">
            <button
              type="button"
            ...
            <div className="modal-body">
              ...
              <div id="login-modal">
                {/* <!-- Login Form --> */}
                <div className="login-form default-form">
                  <RegisterAdmin onReset={setResetForm} myAdminError={myAdminError} closeAdminMe={closeAdminMe} myAdminToast={myAdminToast} />
                </div>
                {/* <!--End Login Form --> */}
              </div>
              {/* <!-- End Login Module --> */}
